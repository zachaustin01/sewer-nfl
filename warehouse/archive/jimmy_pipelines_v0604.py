...
def pipe_points_per_epa(api_data, trailing_weeks = 5):
    ...
    # read_df = df_final[df_final['season']>2021]

    # read_df.groupby(['season','team'], as_index = False)['points_per_epa'].mean().sort_values('points_per_epa')
...
def pipe_def_burn_commit(api_data, next_gen_stats_rec, next_gen_stats_rush, trailing_weeks = 5):
